...
public class OnebyoneInquiry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.onebyone_inquiry);
    ...
    private void showCustomDialog() {
        ...
        View dialogView = getLayoutInflater().inflate(R.layout.dialog_inquiry, null);
