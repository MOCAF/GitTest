...
public class Post extends AppCompatActivity {
    ...
    static class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
        ...
        public PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_post_buttons, parent, false);
        ...
        public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
            ...
            holder.changeImageButton.setOnClickListener(v -> {
                ((Post) context).openImageChooser(holder.imageView);
            });
        }
        ...
        private void showCustomDialog(ImageView imageView, int position) {
            ...
            View dialogView = LayoutInflater.from(context).inflate(R.layout.edit_inquiry, null);
            ...
            selectedImage.setOnClickListener(v -> ((Post) context).openImageChooser(selectedImage));
